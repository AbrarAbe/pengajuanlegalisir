        ...
        <section id="content" class="p-4 p-md-5 pt-5">
            ...
            <section>
                <?php if ($row = mysqli_fetch_assoc($result)) {
                    ...
                    if ($_SESSION['role'] == 'alumni' && ($row['keterangan'] !== 'Menunggu Pembayaran')) {
                        echo "
                                ...
                                <article class='row g-3 mb-4'>
                                    ...
                                    <article class='col-sm'>
                                        <article class='d-grid'>
                                            <a class='button-6' href='status_pengajuan.php'>Kembali</a>
                                        </article>
                                    </article>
                                </article>
                        ";
                    } elseif ($_SESSION['role'] == 'alumni' && ($row['keterangan'] == 'Menunggu Pembayaran')) {
                        echo "
                            <h2 class='mb-4'>Dokumen</h2>
                                <article class='row g-3 mb-4'>
                                    <article class='col-sm-8 d-flex gap-2'>
                        ...
                        ";
                    } elseif ($_SESSION['role'] == 'staf' && ($row['keterangan'] == 'Penentuan Ekspedisi')) {
                        echo "
                            <h2 class='mb-4'>Dokumen</h2>
                                <article class='row g-3 mb-4'>
                                    <article class='col-sm-8 d-flex gap-2'>
