                ...
                <div class="card bg-glass">
                    <div class="card-body px-4 py-5 px-md-5">
                        <form action="" method="post">
                            ...
                            <div id="passwordHelpBlock" class="form-text mb-4 d-flex" style="color:whitesmoke;">
                            ...
                            if (isset($_POST['submit'])) {
                                ...
                                if ($stmt = $conn->prepare($sql)) {
                                    ...
                                    if ($result->num_rows > 0) {
                                        echo '<div class="alert alert-warning alert-dismissible fade show" role="alert"><strong>Email sudah ada !</strong> <a href="login_alumni.php">Masuk</a> atau gunakan email lain.
