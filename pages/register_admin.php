        ...
        <nav id="sidebar" class="nav-bg-light">
            ...
            <article class="container d-grid p-4">
                ...
                <ul class="list-unstyled components mb-4">
                    ...
                    <li class="active">
                        <a href="register_admin.php" class="nav-link cursor-pointer"><span class="fa fa-user-plus mr-4"></span>Daftar
                            Admin</a>
                    </li>
                </ul>
