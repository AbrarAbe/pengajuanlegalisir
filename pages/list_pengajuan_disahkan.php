		...
		<nav id="sidebar" class="nav-bg-light">
			...
			<article class="container d-grid p-4 position-fixed" style="max-width: 270px">
				...
				<ul class="list-unstyled components mb-5">
					...
					<li class="active">
						<a href="list_pengajuan_disahkan.php" class="nav-link cursor-pointer"><span
								class="fa fa-file-lines ml-1 mr-4"></span> Legalisir</a>
					</li>
					<li>
						<a href="#" id="theme-toggle" class="nav-link cursor-pointer"><span id="theme-icon" class="fa fa-sun ml-1 mr-4"></span>
							Ganti Tema</a>
					</li>
					<li>
