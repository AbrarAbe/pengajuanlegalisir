...
document.addEventListener("DOMContentLoaded", function () {
  ...
  window.intlTelInput(input, {
    ...
    utilsScript:
      "https://cdn.jsdelivr.net/npm/intl-tel-input@23.7.3/build/js/utils.js", // for formatting/validation etc.
...
function updateTotal() {
  ...
  var totalHarga =
    legalisirIjazah * hargaIjazah + legalisirTranskrip * hargaTranskrip; // Harga per legalisir, misalnya Rp. 10.000
...
function openModal() {
  ...
  const openSecondStepModal = document.getElementById("openSecondStepModal");
  openSecondStepModal.addEventListener("click", () => {
    firstStepModal.classList.remove("d-block");
    firstStepModal.classList.add("d-none");
    secondStepModal.classList.remove("d-none");
    secondStepModal.classList.add("d-block");
    thirdStepModal.classList.remove("d-block");
    thirdStepModal.classList.add("d-none");
  });

  const openThirdStepModal = document.getElementById("openThirdStepModal");
  openThirdStepModal.addEventListener("click", () => {
    firstStepModal.classList.remove("d-block");
    firstStepModal.classList.add("d-none");
    secondStepModal.classList.remove("d-block");
    secondStepModal.classList.add("d-none");
    thirdStepModal.classList.remove("d-none");
    thirdStepModal.classList.add("d-block");
  });

  const backToFirstModal = document.querySelectorAll(
    "#backToFirstModal, #openModal"
  );
  backToFirstModal.forEach((element) => {
    element.addEventListener("click", () => {
      firstStepModal.classList.remove("d-none");
      firstStepModal.classList.add("d-block");
      secondStepModal.classList.remove("d-block");
      secondStepModal.classList.add("d-none");
      thirdStepModal.classList.remove("d-block");
      thirdStepModal.classList.add("d-none");
  ...
  const backToSecondModal = document.getElementById("backToSecondModal");
  backToSecondModal.addEventListener("click", () => {
    firstStepModal.classList.remove("d-block");
    firstStepModal.classList.add("d-none");
    secondStepModal.classList.remove("d-none");
    secondStepModal.classList.add("d-block");
